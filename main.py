...
def get_latest_release_info(repo):
    api_url = f"https://api.github.com/repos/{USERNAME-OF-OWNER-OF-REPO}/{REPO-NAME}/releases/latest" # Remove the brackets
...
if __name__ == "__main__":
    ...
    repo = "{USERNAME}/{REPO-NAME}" # EDIT THI. Remove the brackets
